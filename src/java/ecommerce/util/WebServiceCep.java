 ...
 * {@link WebServiceCep#searchCep(String)} para maiores informações.
 * <BR>
 * <BR>Constroi um objeto {@link WebServiceCep} com os dados XML encapsulados, a
 * partir da chamada do método estatico {@link WebServiceCep#searchCep(String)}.
 * <BR>
 * <BR>Objeto contem todas as informações do XML, além de informações referente
 ...
 * <BR>&nbsp; &nbsp; System.out.println("Descrição do erro: " +
 * cep.getResultText());
 * <BR>}
 * <BR></tt>
...
public final class WebServiceCep {
    ...
    private static final class XmlEnums {
        ...
        /**
         * Busca um Enum {@link Xml} a partir do seu nome, a busca não é case
    ...
    /**
     * Mascara para a string url de conexão, onde <tt>"%s"</tt> é substituido
     * pelo valor do cep.
     */
     ...
     * @throws DocumentException Quando há problema na formação do documento
     * XML.
     ...
     * <BR>
     * <BR>Não se faz necessário formatações, a string pode ser enviada em
     * qualquer formatação, pois só serão consideradas os primeiros 8 numeros da
     * string.
     * <BR>Por Exemplo:
     * <BR>Uma <tt>{@link String} "14.568-910"</tt> é automaticamente passada
     * para
     * <tt>"14568910"</tt>.
     * <BR>Uma <tt>{@link String} "1%4#5?55%16a8#910"</tt> é automaticamente
     * passada para
     * <tt>"14555168"</tt>, só levando em conta os primeiros 8 números.
     *
     * @param	cep Número do cep a ser carregado. Só serão considerados os
     * primeiros 8 números da {@link String} enviada. Todos os caracters não
     * numéricos serão removidos, e a string será truncada caso seja maior que 8
     * caracters.
    ...
    /**
     * Privado para que seja invocado apenas através de
     ...
     * <BR><tt>-14</tt> : Site não encontrado (pode ser por problemas na
     * internet).
    ...
    /**
     * Pega a exceção que ocorreu durante a busca, retorna null caso não haja
     * exceções.
     *
